export const termsAndConditionsData = {
  lastUpdated: "Month Date, 2026",
  companyName: "Zryth Solutions",
  content: `TERMS AND CONDITIONS
Last updated Month Date, 2026

AGREEMENT TO OUR LEGAL TERMS
We are Zryth Solutions ('Company', 'we', 'us', or 'our').

We operate the website https://www.zryth.com/ (the 'Site'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').

We specialize in delivering cutting-edge technology solutions that harness the power of AI to transform businesses across industries. From intelligent CRM systems to smart booking platforms, we build software that adapts and grows with your needs.

You can contact us by phone at +91-7455900568, email at kushagra@zryth.com, manas@zryth.com.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Zryth Solutions, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
16. GOVERNING LAW
These Legal Terms shall be governed by and defined following the laws of India. Zryth Solutions and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.

17. DISPUTE RESOLUTION
You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the India courts. Zryth Solutions shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.
